...
public interface PostRepository extends JpaRepository<Post, Long> {
    ...
    // 장소리뷰 - 인기순
//    List<Post> findAllByIsPublicAndPlaceOrderByLikesCntDescIdDesc(boolean isPublic, Place place, Pageable pageable);
//    List<Post> findByIsPublicAndPlaceAndIdLessThanOrderByLikesCntDescIdDesc(boolean isPublic, Place place, Long lastId, Pageable pageable);
    // 장소리뷰 - 최신순
